    ...
    <body>
        ...
        <div id = "DashboardBody"> 
            ...
            <div id = "DashboardContent">
                <h1>Palit password DITO TAEE!</h1>
                <form method = "POST" action = "ChangePassword">
                    <label>Change your password here</label>
                    <hr>
                    <label for = "oldpwordC">Old Password</label><br>
                    <input name = "oldpwordC" type = "password" placeholder = "Enter old password" required><br>
                    <label for = "newpwordC">New Password</label><br>
                    <input name = "newpwordC" type = "password" placeholder = "Enter New password" required><br>
                    <label for = "newpwordC2">Confirm New Password</label><br>
                    <input name = "newpwordC2" type = "password" placeholder = "Enter Password again" required><br><br>
                    <%
