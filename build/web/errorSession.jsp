    ...
    <body style="background-color:white">
        ...
        <div style="min-height:100vh;line-height: 1.5; display: flex; align-items: center; justify-content: space-around;text-align: center; ">
            <div style="text-align: center;">
                ...
                <h1 style="font-family: 'Patua One', cursive;font-size: clamp(50px,100%,80px); font-weight: normal; letter-spacing: 0.1em;">ERROR: 419</h1>
                <center><h2 style="font-family: 'Roboto', sans-serif;font-weight: normal;"> Uh Oh Buddy! your session has expired! </h2></center>
